...
import { NamespaceCtx } from '@renderer/modules/detail/namespaceContext'
import EntryEditor, { CollabsibleTranslationsEntry } from '@renderer/modules/detail/entryEditor'
